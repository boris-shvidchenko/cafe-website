// Note: The data was obtained from https://sampleapis.com/api-list/coffee. Some of the images and descriptions have been modified.

export const drinks = [
    {
      "title": "Latte",
      "description": "The latte is comprised of a shot of espresso and steamed milk with just a touch of foam.",
      "ingredients": [
        "Espresso",
        "Steamed Milk"
      ],
    ...
    },
    {
      ...
      "image": "https://images.pexels.com/photos/685527/pexels-photo-685527.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
      "id": 5
    },
    {
      "title": "Doppio",
    ...
    {
      "title": "Cortado",
      "description": "A cortado has the perfect balance of espresso and warm steamed milk. The milk is used to cut back on the espresso’s acidity.",
      "ingredients": [
        "1oz Espresso",
        "1oz Steamed Milk"
      ],
    ...
    {
      "title": "Red Eye",
      "description": "A full cup of hot coffee with an espresso shot mixed in.",
      "ingredients": [
        "Coffee",
        "Espresso"
      ],
    ...
    {
      "title": "Macchiato",
      "description": "The macchiato is an espresso-based drink that has a small amount of foam on top.",
      "ingredients": [
        "Espresso",
        "Foam"
      ],
      "image": "https://images.pexels.com/photos/62428/pexels-photo-62428.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
      "id": 11
    },
    {
      "title": "Mocha",
      "description": "The mocha is a chocolate espresso drink with steamed milk and foam.",
      "ingredients": [
        "Espresso",
        "Steamed Milk",
        "Chocolate"
    ...
    {
      "title": "Ristretto",
      "description": "Ristretto is an espresso shot that uses less hot water to create a sweeter flavor compared to a traditional shot of espresso.",
      "ingredients": [
    ...
    {
      "title": "Affogato",
      "description": "The affogato is served with a scoop of ice cream and a shot of espresso, or two.",
      "ingredients": [
        "Espresso",
        "Ice cream"
      ],
    ...
    {
      "title": "Café au Lait",
      "description": "Café au lait is perfect for the coffee minimalist who wants a bit more flavor.",
      "ingredients": [
        "Coffee",
        "Steamed Milk"
      ],
