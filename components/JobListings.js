    ...
    return (
        <div className='page-sizing pt-10'>
            ...
            <table className='mb-10 ml-10 md:ml-0 border-separate border-spacing-x-6 border-spacing-y-1'>
                <tr><td className='jobs-titles'>Manager</td><td className='jobs-link'>{`Apply Now >`}</td></tr>
                <tr><td className='jobs-titles'>{`Barista (Part-Time)`}</td><td className='jobs-link'>{`Apply Now >`}</td></tr>
             </table>
