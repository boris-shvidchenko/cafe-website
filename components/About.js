    ...
    return (
        <div className='page-sizing mt-5 md:mt-10'>
            ...
            <section className='lg:flex justify-between mb-10'>
                <p className='lg:hidden mx-10 md:mx-1 mb-7 md:mb-10 body-text'>Opened in 2018, West Oceanside Coffee has been serving the local community with high quality coffee from locally sourced products. We offer a variety of drinks, menu items, and other products. Drop by and grab something to go, hang out after a surf session, or simply come and enjoy our beach side location with your friends and family!</p>
                <Image
                ...
                <section className='xl:flex flex-col space-y-4'>
                    <p className='hidden lg:block ml-9 body-text'>Opened in 2018, West Oceanside Coffee has been serving the local community with high quality coffee from locally sourced products. We offer a variety of drinks, menu items, and other products. Drop by and grab something to go, hang out after a surf session, or simply come and enjoy our beach side location with your friends and family!</p>
